...
- Added support for circular references in JSON Schema
  - Implemented prototype-based resolution for circular references
  - Added handling for self-references using '#'
  - Added support for nested circular references
- Added documentation about parser limitations
  - Documented behavior with anyOf/oneOf/allOf
  - Clarified validation scope and type coercion rules
